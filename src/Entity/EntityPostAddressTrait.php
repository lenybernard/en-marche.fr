...
trait EntityPostAddressTrait
{
    ...
    /**
     * @SymfonySerializer\Groups({"user_profile", "adherent_change_diff", "committee_read"})
     */
    ...
    /**
     * @SymfonySerializer\Groups({"committee_read"})
     */
    ...
    /**
     * @SymfonySerializer\Groups({"adherent_change_diff", "user_profile", "committee_read", "export", "adherent_autocomplete"})
     */
    ...
    /**
     * @SymfonySerializer\Groups({"adherent_change_diff", "committee_read"})
     */
