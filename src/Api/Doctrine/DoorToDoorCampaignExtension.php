...
use App\Entity\DoorToDoor\Campaign;
use Doctrine\ORM\QueryBuilder;
use Symfony\Component\Security\Core\Security;

class DoorToDoorCampaignExtension implements QueryItemExtensionInterface, QueryCollectionExtensionInterface
{
    ...
    private function modifyQuery(QueryBuilder $queryBuilder, string $resourceClass): void
    {
        if (Campaign::class !== $resourceClass
            || $this->security->isGranted('HAS_FEATURE_DOOR_TO_DOOR')) {
            return;
        }
